    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      <div className="p-6 bg-white rounded-2xl border border-zinc-200 shadow-sm">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <p className="text-sm font-medium text-zinc-500">Total Inventory Value</p>
            <h3 className="text-2xl font-bold text-zinc-900">${totalValue.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 bg-white rounded-2xl border border-zinc-200 shadow-sm">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <p className="text-sm font-medium text-zinc-500">Total Unique Products</p>
            <h3 className="text-2xl font-bold text-zinc-900">{totalItems}</h3>
          </div>
        </div>
      </div>

      <div className="p-6 bg-white rounded-2xl border border-zinc-200 shadow-sm lg:col-span-2">
        <div className="flex items-center gap-4 mb-4">
          <div className="p-3 bg-emerald-50 text-emerald-600 rounded-xl">
            <Activity className="w-6 h-6" />
          </div>
          <div>
            <p className="text-sm font-medium text-zinc-500">Stock Health Status</p>
        ...
        {totalItems > 0 ? (
          <div className="h-4 w-full bg-zinc-100 rounded-full flex overflow-hidden">
          ...
          <div className="h-4 w-full bg-zinc-100 rounded-full"></div>
        )}
      </div>
    </div>
  );
